...
interface Proxy {
  ...
  // Bytes are encoded as array of numbers
  @Handler suspend fun call(request: ProxyRequest): ByteArray

  // Returns the invocation id of the call
  @Handler suspend fun oneWayCall(request: ProxyRequest): String

  @Handler suspend fun manyCalls(requests: List<ManyCallRequest>)
}
