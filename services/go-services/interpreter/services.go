...
var ServiceInterpreterHelperRouter = restate.NewServiceRouter().
	...
	})).Handler("echoLater", restate.NewServiceHandler(func(ctx restate.Context, parameter EchoLaterRequest) (string, error) {
...
})).Handler("resolveAwakeable", restate.NewServiceHandler(func(ctx restate.Context, id string) (restate.Void, error) {
	return restate.Void{}, restate.ResolveAwakeableAs(ctx, id, "ok")
})).Handler("rejectAwakeable", restate.NewServiceHandler(func(ctx restate.Context, id string) (restate.Void, error) {
	return restate.Void{}, ctx.RejectAwakeable(id, fmt.Errorf("error"))
})).Handler("incrementViaAwakeableDance", restate.NewServiceHandler(func(ctx restate.Context, input IncrementViaAwakeableDanceRequest) (restate.Void, error) {
	//
	...
	//
	restate.ResolveAwakeableAs[string](ctx, input.TxPromiseId, awakeable.Id())
	//
