...
import { AwakeableHolderServiceClientImpl, HoldRequest } from "./generated/awakeable_holder";

export const KillTestServiceFQN = protobufPackage + ".KillTestService";
export const KillSingletonServiceFQN = protobufPackage + ".KillSingletonService";
